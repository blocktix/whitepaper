...
\title{Blocktix: a network that fixes the counterfeiting, high fees and poor user experience of online ticket sales}
...
Imagine showing up to an event with tickets only to find out your tickets weren't valid, that you had been hoodwinked by a malevolont online scalper, or that you paid an exorbitant fee to a third party online service when better, less expensive tickets were available going direct with your event organizer.

Such problems are widespread in the huge, worldwide market of ticket sales.  It's a market begging for a decentralized, peer to peer solution that makes it easy, inexpensive and safe for event organizers and ticket buyers alike.
