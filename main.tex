...
\title{Blocktix: a network that fixes the counterfeiting, high fees, and poor user experience of event promotion}
...
\begin{abstract}
You'd think buying a ticket online to the Super Bowl or your local rock concert might seem like a simple, safe process, but it is currently one rife with problems.  

Imagine showing up to an event with tickets only to find out your tickets weren't valid, that you had been hoodwinked by a malevolont online scalper, or that you paid an exorbitant fee to a third party online service when better, less expensive tickets were available going direct.

Such problems haunt the huge, worldwide market of event promotion.  It's a market begging for a decentralized, peer to peer solution that makes it easy, inexpensive and safe for event organizers and ticket buyers alike.

That solution is Blocktix.

\end{abstract}

\section{Introduction}

Blocktix provides a decentralized event promotion network that runs on the Ethereum blockchain that you can use to buy and sell tickets through unforgeable cryptographic signatures. This approach simplifies the process and removes the expensive and troublesome infrastructure of centralized servers. Buyer and seller get to enjoy the low fees and reliability. .\par
\vspace{5mm}
...
Anyone will be able to purchase advertising rights for an event. These funds will be distributed to partly to 'Blocktix Sales B.V.' and partly to the users on the system that watch the advertisements.  The event feed always starts with two "promoted events". When an event is being promoted, the advertisement has a random chance to appear in one of these two promoted spots.
